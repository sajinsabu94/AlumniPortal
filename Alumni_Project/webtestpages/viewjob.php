              ...
              <table class="table table-message">
                <tbody>
                  <tr class="heading">
                   ...
                   <?php 	
	$viewsql="SELECT register_no,postby,jobcode,jobtitle,jobtype,compname,compaddress,compsite,opendate,                			                    closedate,vacancy,salaray,qualif, skill, descrip,post_date FROM tbl_jobpost";
          ...
          while($rowreg=mysql_fetch_array($resultview))
          {
			?>
                  ...
                  <tr>
                    ...
                    <td class="cell-title">  <a href="viewjobdetail.php?id=<?php echo $rowreg["register_no"];?>" > View </td></a> 
                  </tr>
