<?php 
 ...
 if(isset($_POST["submit"]))
  {
	  $selmax="SELECT MAX(post_id) AS id FROM tbl_signup"; 
    ...
    $jobsql="INSERT INTO tbl_jobpost(post_id,register_no,postby, jobcode, jobtitle, jobtype, compname, compaddress, compsite, opendate,closedate,vacancy, salaray, qualif, skill, descrip,post_date) VALUES ('".$tabid."''".$_SESSION["register_no"]."',
